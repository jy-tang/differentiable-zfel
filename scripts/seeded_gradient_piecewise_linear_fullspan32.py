...
OUTDIR = Path("docs/examples/generated_plots/seeded_gradient_piecewise_linear_fullspan32_p2e8_2026-04-15")
N_KNOTS = 32
...
def warm_start_from_reference():
    # Warm-start from the best 24-knot full-span piecewise-linear run.
    z_grid = np.linspace(0.0, 1.0, BASE_INPUT["z_steps"])
    piecewise_summary = json.loads(
        Path(
            "docs/examples/generated_plots/seeded_gradient_piecewise_linear_fullspan24_p2e8_2026-04-15/"
